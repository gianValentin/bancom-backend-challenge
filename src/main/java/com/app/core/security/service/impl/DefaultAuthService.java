...
public class DefaultAuthService implements AuthService {
	...
	public AuthDto login(LoginDto dto) {
		...
		SecurityUser user = securityUserRepository.findByName(dto.getName()).orElseThrow();
	...
	public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
	    ...
	    if (username != null) {
	      SecurityUser user = securityUserRepository.findByName(username)
	              .orElseThrow();
	...
	public boolean isUsernameValid(String username) {		
		return !securityUserRepository.existsSecurityUserByName(username);
	}
